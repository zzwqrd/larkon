...
docker exec larkon-laravel.test-1 php artisan migrate:fresh --seed
docker exec larkon-laravel.test-1 php artisan cache:clear
docker exec larkon-laravel.test-1 php artisan config:clear
