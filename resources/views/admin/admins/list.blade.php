...
@section('content')
    <div class="row">
        <div class="col-xl-12">
            <x-ui.table-card title="Admins List" :addRoute="route('admin.admins.create')" :indexRoute="route('admin.admins.list')"
                :deleteRoute="url('admin/admins')" :deleteAllRoute="route('admin.admins.bulkDelete')">
