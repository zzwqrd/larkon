@extends('layouts.vertical', ['title' => __('messages.sizes')])
@section('content')
<div class="row">
    <div class="col-xl-12">
        <x-ui.table-card
            :title="__('messages.sizes')"
            :addRoute="route('admin.sizes.create')"
            :indexRoute="route('admin.sizes.index')"
            :deleteRoute="url('general/sizes')"
            :deleteAllRoute="route('admin.sizes.bulkDelete')">
