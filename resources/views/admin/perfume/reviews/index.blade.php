@extends('layouts.vertical', ['title' => __('messages.reviews')])
@section('content')
<div class="row">
    <div class="col-xl-12">
        <x-ui.table-card
            :title="__('messages.reviews')"
            :addRoute="route('admin.reviews.create')"
            :indexRoute="route('admin.reviews.index')"
            :deleteRoute="url('general/reviews')"
            :deleteAllRoute="route('admin.reviews.bulkDelete')">
