@extends('layouts.vertical', ['title' => __('messages.essential_oils')])
@section('content')
<div class="row">
    <div class="col-xl-12">
        <x-ui.table-card
            :title="__('messages.essential_oils')"
            :addRoute="route('admin.essential-oils.create')"
            :indexRoute="route('admin.essential-oils.index')"
            :deleteRoute="url('general/essential-oils')"
            :deleteAllRoute="route('admin.essential-oils.bulkDelete')">
