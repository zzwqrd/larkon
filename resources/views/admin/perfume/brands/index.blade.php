@extends('layouts.vertical', ['title' => __('messages.brands')])
@section('content')
<div class="row">
    <div class="col-xl-12">
        <x-ui.table-card
            :title="__('messages.brands')"
            :addRoute="route('admin.brands.create')"
            :indexRoute="route('admin.brands.index')"
            :deleteRoute="url('general/brands')"
            :deleteAllRoute="route('admin.brands.bulkDelete')">
