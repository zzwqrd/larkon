@extends('layouts.vertical', ['title' => __('messages.oil_categories')])
@section('content')
<div class="row">
    <div class="col-xl-12">
        <x-ui.table-card
            :title="__('messages.oil_categories')"
            :addRoute="route('admin.oil-categories.create')"
            :indexRoute="route('admin.oil-categories.index')"
            :deleteRoute="url('general/oil-categories')"
            :deleteAllRoute="route('admin.oil-categories.bulkDelete')">
