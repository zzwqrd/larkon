@extends('layouts.vertical', ['title' => __('messages.notes')])
@section('content')
<div class="row">
    <div class="col-xl-12">
        <x-ui.table-card
            :title="__('messages.notes')"
            :addRoute="route('admin.notes.create')"
            :indexRoute="route('admin.notes.index')"
            :deleteRoute="url('general/notes')"
            :deleteAllRoute="route('admin.notes.bulkDelete')">
