@extends('layouts.vertical', ['title' => __('messages.formulas')])
@section('content')
<div class="row">
    <div class="col-xl-12">
        <x-ui.table-card
            :title="__('messages.formulas')"
            :addRoute="route('admin.formulas.create')"
            :indexRoute="route('admin.formulas.index')"
            :deleteRoute="url('manufacturing/formulas')"
            :deleteAllRoute="route('admin.formulas.bulkDelete')">
