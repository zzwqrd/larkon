@extends('layouts.vertical', ['title' => __('messages.coupons')])
@section('content')
<div class="row">
    <div class="col-xl-12">
        <x-ui.table-card
            :title="__('messages.coupons')"
            :addRoute="route('admin.coupons.create')"
            :indexRoute="route('admin.coupons.index')"
            :deleteRoute="url('orders/coupons')"
            :deleteAllRoute="route('admin.coupons.bulkDelete')">
