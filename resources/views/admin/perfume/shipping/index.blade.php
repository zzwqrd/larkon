@extends('layouts.vertical', ['title' => __('messages.shipping_methods')])
@section('content')
<div class="row">
    <div class="col-xl-12">
        <x-ui.table-card
            :title="__('messages.shipping_methods')"
            :addRoute="route('admin.shipping.create')"
            :indexRoute="route('admin.shipping.index')"
            :deleteRoute="url('general/shipping')"
            :deleteAllRoute="route('admin.shipping.bulkDelete')">
