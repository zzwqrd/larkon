<div class="main-nav">
    ...
    <div class="scrollbar" data-simplebar>
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarProducts">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'products', 'list'])}}">{{ __('messages.list') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'products', 'grid'])}}">{{ __('messages.grid') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'products', 'detail'])}}">{{ __('messages.details') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'products', 'edit'])}}">{{ __('messages.edit') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'products', 'create'])}}">{{ __('messages.create') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarCategory">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'category', 'list'])}}">{{ __('messages.list') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'category', 'edit'])}}">{{ __('messages.edit') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'category', 'create'])}}">{{ __('messages.create') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarInventory">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'inventory', 'warehouse'])}}">{{ __('messages.warehouse') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'inventory', 'received-orders'])}}">{{ __('messages.received_orders') }}</a>
                        </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarOrders">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'orders', 'list'])}}">{{ __('messages.list') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'orders', 'details'])}}">{{ __('messages.details') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'orders', 'cart'])}}">{{ __('messages.cart') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'orders', 'checkout'])}}">{{ __('messages.checkout') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarPurchases">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'purchase', 'list'])}}">{{ __('messages.list') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'purchase', 'order'])}}">{{ __('messages.order') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'purchase', 'return'])}}">{{ __('messages.return') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarAttributes">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'attributes', 'list'])}}">{{ __('messages.list') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'attributes', 'edit'])}}">{{ __('messages.edit') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'attributes', 'create'])}}">{{ __('messages.create') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarInvoice">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'invoice', 'list'])}}">{{ __('messages.list') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['general', 'invoice', 'details'])}}">{{ __('messages.details') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{route('third', ['general', 'invoice', 'create'])}}">{{ __('messages.create') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
                ...
                <div class="collapse" id="sidebarRoles">
                    <ul class="nav sub-navbar-nav">
                        <ul class="nav sub-navbar-nav">
                            <li class="sub-nav-item">
                                <a class="sub-nav-link"
                                    href="{{ route('third', ['users', 'role', 'list'])}}">{{ __('messages.list') }}</a>
                            </li>
                            <li class="sub-nav-item">
                                <a class="sub-nav-link"
                                    href="{{ route('third', ['users', 'role', 'edit'])}}">{{ __('messages.edit') }}</a>
                            </li>
                            <li class="sub-nav-item">
                                <a class="sub-nav-link"
                                    href="{{ route('third', ['users', 'role', 'create'])}}">{{ __('messages.create') }}</a>
                            </li>
                        </ul>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarCustomers">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['users', 'customer', 'list'])}}">{{ __('messages.list') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['users', 'customer', 'details'])}}">{{ __('messages.details') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarSellers">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['users', 'seller', 'list'])}}">{{ __('messages.list') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['users', 'seller', 'details'])}}">{{ __('messages.details') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['users', 'seller', 'edit'])}}">{{ __('messages.edit') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['users', 'seller', 'create'])}}">{{ __('messages.create') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarCoupons">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['other', 'coupons-list'])}}">{{ __('messages.list') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['other', 'coupons-add'])}}">{{ __('messages.add') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarPages">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['custom', 'pages', 'starter'])}}">{{ __('messages.welcome_page') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['custom', 'pages', 'coming-soon'])}}">{{ __('messages.coming_soon') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['custom', 'pages', 'timeline'])}}">{{ __('messages.timeline') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['custom', 'pages', 'pricing'])}}">{{ __('messages.pricing') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['custom', 'pages', 'maintenance'])}}">{{ __('messages.maintenance') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['custom', 'pages', 'error-404'])}}">{{ __('messages.error_404') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['custom', 'pages', 'error-404-alt'])}}">{{ __('messages.error_404') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarAuthentication">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['auth', 'login']) }}">{{ __('messages.sign_in') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['auth', 'register']) }}">{{ __('messages.sign_up') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['auth', 'reset-password']) }}">{{ __('messages.reset_password') }}</a>
                        </li>
                        <li class="sub-nav-item">
            ...
            <li class="menu-title mt-2">{{ __('messages.components_ui') }}</li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarBaseUI">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'accordion'])}}">Accordion</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'alerts'])}}">Alerts</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'avatar'])}}">Avatar</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'badge'])}}">Badge</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'breadcrumb'])}}">Breadcrumb</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'buttons'])}}">Buttons</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'cards'])}}">Card</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'carousel'])}}">Carousel</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'collapse'])}}">Collapse</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'dropdown'])}}">Dropdown</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'list-group'])}}">List Group</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'modal'])}}">Modal</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['components_ui', 'ui', 'tabs'])}}">Tabs</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'offcanvas'])}}">Offcanvas</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'pagination'])}}">Pagination</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'placeholder'])}}">Placeholders</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'popovers'])}}">Popovers</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'progress'])}}">Progress</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'scrollspy'])}}">Scrollspy</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'spinners'])}}">Spinners</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'toasts'])}}">Toasts</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'ui', 'tooltips'])}}">Tooltips</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarExtendedUI">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'advanced', 'rating'])}}">Ratings</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'advanced', 'sweet-alerts'])}}">Sweet
                                Alert</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'advanced', 'swiper-slider'])}}">Swiper
                                Slider</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'advanced', 'scrollbar'])}}">Scrollbar</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'advanced', 'toastify'])}}">Toastify</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarCharts">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-area'])}}">Area</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-bar'])}}">Bar</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-bubble'])}}">Bubble</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-candlestick'])}}">Candlestick</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-column'])}}">Column</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-heatmap'])}}">Heatmap</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-line'])}}">Line</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-mixed'])}}">Mixed</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-timeline'])}}">{{ __('messages.timeline') }}</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-boxplot'])}}">Boxplot</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-treemap'])}}">Treemap</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-pie'])}}">Pie</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-radar'])}}">Radar</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-radialbar'])}}">RadialBar</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-scatter'])}}">Scatter</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'charts', 'apex-polar-area'])}}">Polar
                                Area</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarForms">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'basic'])}}">Basic Elements</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'checkbox-radio'])}}">Checkbox &amp;
                                Radio</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'choice-select'])}}">Choice
                                Select</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'clipboard'])}}">Clipboard</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'flatepicker'])}}">Flatepicker</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'validation'])}}">Validation</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'wizard'])}}">Wizard</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'file-upload'])}}">File Upload</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'editors'])}}">Editors</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'input-mask'])}}">Input Mask</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'forms', 'range-slider'])}}">Slider</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarTables">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'tables', 'basic'])}}">Basic Tables</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'tables', 'gridjs'])}}">Grid Js</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarIcons">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'icons', 'boxicons'])}}">Boxicons</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'icons', 'solar'])}}">Solar Icons</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarMaps">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'maps', 'google'])}}">Google Maps</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('third', ['components_ui', 'maps', 'vector'])}}">Vector Maps</a>
                        </li>
                    </ul>
                </div>
            </li>
                        ...
                        <li class="sub-nav-item">
                            ...
                            <div class="collapse" id="sidebarItemDemoSubItem">
                                <ul class="nav sub-navbar-nav">
                                    <li class="sub-nav-item">
                                        <a class="sub-nav-link"
                                            href="javascript:void(0);">{{ __('messages.menu_sub_item') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
